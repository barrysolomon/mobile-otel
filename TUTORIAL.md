...
**iOS** — SwiftPM, repo `https://github.com/barrysolomon/mobile-otel` at tag `v0.4.1-alpha`, product `OTelMobileSDK`.

**React Native** — npm, under the `alpha` dist-tag (a bare install gets the older 0.1.0-alpha):

```bash
npm install @barrysolomon/mobile-react-native@alpha   # or @0.4.1-alpha
```
