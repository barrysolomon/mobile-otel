...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        trackBreadcrumb("view_profile")
    }

    private fun loadUserProfile() {
        // TODO: Load from SessionManager when implemented
