...
- **Shipped release: `v0.4.2-alpha`** (see [CHANGELOG.md](../CHANGELOG.md))
...
The package lives at the repo root in `otel-ios-mobile/`. In `Package.swift`, pin the shipped tag `v0.4.2-alpha`:
