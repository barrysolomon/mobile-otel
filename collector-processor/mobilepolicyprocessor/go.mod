module github.com/open-telemetry/opentelemetry-collector-contrib/processor/mobilepolicyprocessor
...
require (
	...
	go.opentelemetry.io/collector/processor/processorhelper v0.91.0
