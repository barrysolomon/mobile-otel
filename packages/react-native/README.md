...
**Version:** `0.2.0-alpha`, published under the `alpha` dist-tag.
...
- **iOS** — add the Swift Package `https://github.com/barrysolomon/mobile-otel`
  at tag `v0.2.0-alpha` to your app target, then copy
  ...
  side.
- **Android** — `io.opentelemetry.android:mobile:0.2.0-alpha` from GitHub
