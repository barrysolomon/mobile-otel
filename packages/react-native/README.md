...
**Version:** `0.4.2-alpha`, published under the `alpha` dist-tag.
...
- **iOS** — add the Swift Package `https://github.com/barrysolomon/mobile-otel`
  at tag `v0.4.2-alpha` to your app target, then copy
  ...
  side.
- **Android** — `io.opentelemetry.android:mobile:0.4.2-alpha` from GitHub
