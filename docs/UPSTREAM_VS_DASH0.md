...
|----------|----------|-------|-------|
| Android native | ✅ `opentelemetry-android` 0.10.0-alpha | ✅ `io.opentelemetry.android:mobile:0.4.0-alpha` | Dash0 `MobileInstrumentation extends AndroidInstrumentation` — upstream modules run via adapter |
