...
- **Version:** `0.4.2-alpha` across all three artifacts (npm `@barrysolomon/mobile-react-native`, Android Maven `io.opentelemetry.android:mobile` + siblings, iOS SwiftPM tag `v0.4.2-alpha`).
