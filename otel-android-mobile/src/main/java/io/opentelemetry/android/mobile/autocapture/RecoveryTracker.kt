                ...
                logger.logRecordBuilder()
                    ...
                    .setAllAttributes(
                        Attributes.builder()
                            ...
                            .put(AttributeKey.stringKey("mobile.anr.user_action"), "force_close")
                            .build()
                    )
                    .emit()
            }
            ...
            logger.logRecordBuilder()
                ...
                .setAllAttributes(
                    Attributes.builder()
                        .put(AttributeKey.stringKey("mobile.session.id"), sessionTracker.getSessionId())
                        .put(AttributeKey.stringKey("mobile.view.id"), sessionTracker.getViewId())
                        .put(AttributeKey.stringKey("mobile.recovery_type"), lastRecoveryType)
                        .put(AttributeKey.longKey("mobile.downtime_ms"), downtimeMs)
                        .build()
                )
                .emit()
