...
class ErrorInstrumentation private constructor(
    ...
    private fun installUncaughtExceptionHandler() {
        Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
            ...
            // Persist RAM buffer to disk synchronously (no network I/O).
            // This ensures app.crash and all recent events survive process
            // death. The next launch detects non-empty disk, emits
            // app.recovery_start, and exports everything.
            try { onCrashPersist?.invoke() } catch (_: Exception) {}
